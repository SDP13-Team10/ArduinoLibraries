/*
  EasyStepper.h - - Stepper library for Wiring/Arduino - Version 0.1
...
class EasyStepper {
  public:
    // constructors:
    EasyStepper(int number_of_steps, int motor_pin_1, int motor_pin_2);
    EasyStepper(int number_of_steps, int motor_pin_1, int motor_pin_2, int motor_pin_3, int motor_pin_4);
