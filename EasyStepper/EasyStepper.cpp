/*
  EasyStepper.cpp - - Stepper library for Wiring/Arduino - Version 0.4
  ...
  Add moveToMinute(int minute)    			(0.3) by Sachin Honnudike and Eric Moore
  Add moveToHour(int hour)        			(0.4) by Sachin Honnudike and Eric Moore
 ...
 */
EasyStepper::EasyStepper(int number_of_steps, int motor_pin_1, int motor_pin_2)
{
...
EasyStepper::EasyStepper(int number_of_steps, int motor_pin_1, int motor_pin_2, int motor_pin_3, int motor_pin_4)
{
  this->step_number = 0;						// which step the motor is on
  this->speed = 0;								// the motor speed, in revolutions per minute
  this->direction = 0;      					// motor direction
  this->last_step_time = 0;    					// time stamp in ms of the last step taken
  this->stepper_position = 0; 					// Number of steps that have gone by/ Keep track of stepper motor position
  this->number_of_steps = number_of_steps;		// total number of steps for this motor
...
void EasyStepper::moveToHour(int hour)
{
	...
	numberOfSteps = (hour/3)*50 + calculateHourOffset(hour%3);
...
void EasyStepper::moveToHour(int hour, int minute)
{
	...
	numberOfSteps = (hour/3)*50 + calculateHourOffset(hour%3) + calculateExtraMinuteOffset(minute);
...
/*
	Function to calculate the extra minute offset for the hour hand
*/
...
void EasyStepper::moveToMinute(int minute)
{
	...
	numberOfSteps = (minute/3)*10 + calculateMinuteOffset(minute%3);
...
/*
	Function to move the stepper motor to a particular minute in normal mode
*/
